var Flotr = (function(){
	...
	/**
	 * @todo make class from plot.
	 */
    function Plot(container, data, options) {
        // data is on the form:
        //   [ series1 series2 ... ]
		 ...
		 */
		var origArgs = Object.clone(arguments);
		...
		this.addEvent = function(eventName, fn, c){ overlay.observe(eventName, fn, c); };
		this.removeEvent = function(eventName, fn, c){ overlay.stopObserving(eventName, fn, c); };
        ...
        function fireSelectedEvent(){
            ...
            overlay.fire('flotr:selected', [ { x1: x1, y1: y1, x2: x2, y2: y2 } ]);
        }
        /**
